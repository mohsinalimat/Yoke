...
//        scrollView.isScrollEnabled = true
        ...
        bookmarkButton.anchor(top: captionLabel.topAnchor, left: nil, bottom: captionLabel.bottomAnchor, right: detailViews.righAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 20)
