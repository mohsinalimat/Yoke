...
class BookingRequestViewController: UIViewController {
    ...
    func constrainViews() {
        ...
        peopleCountStackView.anchor(top: peopleCountViewBG.topAnchor, left: nil, bottom: peopleCountViewBG.bottomAnchor, right: peopleCountViewBG.rightAnchor, paddingTop: 5, paddingLeft: 0, paddingBottom: 5, paddingRight: 5, width: 200)
